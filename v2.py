...
class DeformConv2d(nn.Module):
    def __init__(self, inc, outc, kernel_size=(3,3), stride=(1,1), padding=(1,1), bias=None, modulation=False):
        """
        Args:
    ...
    def forward(self, x):   #(256, 1, 128, 9)
        ...
        # (b, 2N, h, w)
        p = self._get_p(offset, dtype) #(256, 18, 128, 9)

        # (b, h, w, 2N)
        p = p.contiguous().permute(0, 2, 3, 1) #(256, 128, 9, 18)
